...
public class HW5Test
{
	...
	/**
	 * Create 3 borrowers One mark for each
	 */
	public void testAddAccount()
	{
		try
		{
			accounts.addAccount(new Account("Ann", "Archer", "1000",
					"1 Amble Way", "Amble", "AA1 1AA"));
			System.out.println("Archer added. Mark so far: " + (++mark));
			numberOfCreatedAccounts++;

			accounts.addAccount(new Account("Barbara", "Bach", "1001",
					"2 Blyth Boulevard", "Blyth", "BB2 2BB"));
			System.out.println("Bach added. Mark so far: " + (++mark));
			numberOfCreatedAccounts++;

			accounts.addAccount(new Account("Colin", "Cowdry", "1002", 3,
		...
		{
			System.out
					.println("An exception was raised in testAddAccount. Current mark ="
							+ mark);
		}
	}
	...
	public void testCapacity()
	{
		try
		{
			...
			{
				System.out.println("Capacity correct("
						+ (accounts.getCapacity()) + "). Mark so far: "
						+ (++mark));
			}
			else
			{
				System.out.println("Capacity incorrect("
						+ (accounts.getCapacity()) + "). No Mark!");
			}
		}
		catch (Exception e)
		{
			System.out
					.println("An exception was raised in testCapacity. Current mark ="
							+ mark);
		}
	}
	...
	public void testNumberOfElements()
	{
		...
		try
		{
			if (accounts.getNumberOfAccounts() == numberOfCreatedAccounts)
			{
				System.out.println("Number of elements correct("
						+ (accounts.getNumberOfAccounts()) + "). Mark so far: "
						+ (++mark));
			}
			else
			{
		...
		{
			System.out
					.println("An exception was raised in testNumberOfElements. "
							+ "Current mark = " + mark);
		}
	}
	...
	public void testValidSearch()
	{
		...
		{
			System.out
					.println("An exception was raised in testValidSearch. Current mark = "
							+ mark);
		}
	}
	...
	public void testInvalidSearch()
	{
		try
		{
			...
			{
				System.out
						.println("testInvalidSearch returned incorrect value:"
								+ searchValue + ".  No Mark!");
			}
		}
		catch (Exception e)
		{
			System.out
					.println("An exception was raised in testInvalidSearch. Current mark ="
							+ mark);
		}
	}
	...
	public void testRemoveValidAccount()
	{
		try
		{
			...
			System.out
					.println("TestRemoveValidAccount - Number of borrowers now:"
							+ accounts.getNumberOfAccounts());

			if (accounts.getNumberOfAccounts() == numberOfCreatedAccounts - 1)
			{
				System.out
						.println("Removal suceeded. Mark so far: " + (++mark));
				numberOfCreatedAccounts--;
			}
			else
			{
		...
		{
			System.out
					.println("An exception was raised in testRemoveValidAccount. "
							+ "Current mark =" + mark);
		}
	}
	...
	public void testRemoveInvalidAccount()
	{
		...
		{
			System.out
					.println("An exception was raised in testRemoveInvalidAccount. "
							+ "Current mark =" + mark);
		}
	}
	...
	public void testValidPrintAccount()
	{
		...
		{
			System.out
					.println("An exception was raised in testValidPrintAccount. "
							+ "Current mark =" + mark);
		}
	}
	...
	public void testInvalidPrintAccount()
	{
		try
		{
			System.out.println("\ntestInvalidPrintAccount");
			System.out
					.println("Output should be: Account with acount number: 1003 not found.\n"
							+ "ACTUAL OUTPUT:");
		...
		{
			System.out
					.println("An exception was raised in testInvalidPrintAccount. "
							+ "Current mark =" + mark);
		}
	}
	...
	public void testPrintAllAccounts()
	{
		...
		{
			System.out
					.println("An exception was raised in testPrintAllAccounts. "
							+ "Current mark =" + mark);
		}
	}
} // end class
