...
public class LabClass
{
	...
	/**
	 * Calculates the average number of points of the students enrolled in the
	 * class
	 *
	 ...
	 * @return The poition of the array where the student is stored or -1 if no
	 *         student was found
	 */
	public int findStudent(String targetName)
	{
		for (Student student : students)
		{
			if (student.getName().equals(targetName)) { return students
					.indexOf(student); }
		}
		return -1;
	}
	...
	/**
	 * Prints details of the class and all the details of each student using a
	 * for each loop
	 *
	 */
	 ...
	 *
	 * @param studentEntry
	 *            The position in the array list to use
	 */
